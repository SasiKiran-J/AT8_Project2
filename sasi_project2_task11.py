...
class Sasi_project2_task11():
    ...
    def activation(self):
        ...
        time.sleep(3)
        terminate_button = driver.find_element(By.XPATH, "//button[@class='oxd-button oxd-button--medium oxd-button--ghost-success --termination-button']")
